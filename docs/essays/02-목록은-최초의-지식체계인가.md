...
```
[1차 사료 비문 라이덴 전사 (DCCLT P365448 / MSL 5)]
1. 𒄑 𒈣 \t\t\t giš-ma2 \t\t = *e-lep-pu* \t\t [실물 판독: 선박 일반]
2. 𒄑 𒈣 𒄥 𒊏 \t\t giš-ma2-gur8 \t = *ma-kur-ru* \t [실물 판독: 심해 항해선 / 의례용 보트]
3. 𒄑 𒈣 𒆭 𒊏 \t\t giš-ma2-dirig \t = *e-lep-pu te-bi-tu* \t [실물 판독: 침몰선 / 침수선]
4. 𒄑 𒈣 𒌑 𒀀 \t\t giš-ma2-u2-a \t = *e-lep-pu ú-a* \t [실물 판독: 갈대 운반선]
5. 𒄑 𒈣 𒋭 𒀀 \t\t giš-ma2-su-a \t = *e-lep-pu šá ma-hi-ri* [실물 판독: 시장 상업선]
```

- **비문학적 고증**: 수메르어 `giš-ma2-gur8`는 굽은 형태의 대형 항해선을 뜻하며 아카드어로 *makurru*로 음역된다. 이 목록은 단순한 단어장이 아니라, 선박의 건조 상태, 용도, 침몰 여부(`dirig`)까지 포괄하여 세계를 관료적으로 표준화하는 체계적 지식 분류였다.
...
```
[우가리트 4개국어 점토판 4열 대조 전사 (RS 20.123+)]
Column I (수메르어 원어)  : 𒂍 (E2) \t\t [표의문자: 집 / 신전]
Column II (아카드어 번역) : *bi-i-tu* (bītu) \t [음절 쐐기문자: 집]
Column III (후르리어 번역): *pur-li* (purli) \t [후르리어 고유어: 집]
Column IV (우가리트어 번역): *be-e-tu* (bêtu) \t [서북셈어 고유어: 집]
```
